        ...
        <div className="relative bg-gray-900">
          ...
          <div className="relative mx-auto flex max-w-3xl flex-col items-center py-32 px-6 text-center sm:py-64 lg:px-0">
            ...
            <p className="mt-4 text-xl text-white">
              ...
              options from our summer small-batch release while they&aposre
              still in stock.
            </p>
            <a
              href="#"
              ...
              <div className="relative bg-gray-900 bg-opacity-75 py-32 px-6 sm:py-40 sm:px-12 lg:px-16">
                <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
                  ...
                  <p className="mt-3 text-xl text-white">
                    ...
                    really a haiku, but we`&apos re doing our best here. No
                    kanban boards, burndown charts, or tangled flowcharts with
                    our Focus system. Just the undeniable urge to fill empty
                    circles.
                  </p>
                  <a
                    href="#"
